...
import static net.austinclarke.randomeyes.RandomFactory.getRFloat;


/**
 * Created by Austin on 11/3/2015.
 */
public class RFloatActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    int listCopyIndex;
    int quantity;
    double min;
    double max;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rfloat_activity);
        ...
        quantityEditText = (EditText) findViewById(R.id.float_quantity);
        minEditText = (EditText) findViewById(R.id.float_min);
        maxEditText = (EditText) findViewById(R.id.float_max);
        mainButton = (Button) findViewById(R.id.float_button);
        mainListView = (ListView) findViewById(R.id.float_list);
        ...
        toolBarTitle.setText(R.string.float_name);
        toolBarImageRight.setImageResource(R.drawable.android_floats);
        ...
        switch (v.getId()) {
            case R.id.float_button:
                try {
                    ...
                    min = minEditText.getText().toString().length() == 0 ? 0 :Float.valueOf(minEditText.getText().toString());
                    max = maxEditText.getText().toString().length() == 0 ? 0 :Float.valueOf(maxEditText.getText().toString());
                ...
                for (int i = 0; i < quantity; i++) {
                    displayList.add(0, String.valueOf(getRFloat(min, max)));
                }
                break;
            default:
