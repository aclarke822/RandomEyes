...
import static net.austinclarke.randomeyes.RandomFactory.getRCard;


/**
 * Created by Austin on 11/3/2015.
 */
public class RCardsActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    int listCopyIndex;
    int quantity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rcards_activity);
        ...
        quantityEditText = (EditText) findViewById(R.id.cards_quantity);
        mainButton = (Button) findViewById(R.id.cards_button);
        mainListView = (ListView) findViewById(R.id.cards_list);
        ...
        toolBarTitle.setText(R.string.cards_name);
        toolBarImageRight.setImageResource(R.drawable.android_cards);
        ...
        switch (v.getId()) {
            case R.id.cards_button:
                ...
                for (int i = 0; i < quantity; i++) {
                    displayList.add(0, getRCard()[0] + " of " + getRCard()[1]);
                }
                break;
            default:
